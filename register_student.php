                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Create a Student Application!</h1>
                            </div>
                            <form class="user" method="POST">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user" pattern="[A-Za-z]{0-9}" name="lname"
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="date" class="form-control form-control-user"
                                            name="dob" title="date of birth" max='<?php echo date('Y-m-d');?>' min ="1961-01-01"required>
                                    </div>
                                    <div class="col-sm-6">
                                 ...
                                 <div class="form-group">
                                    <select name="gender" class="form-control" required><option>Female</option><option>Male</option></select>
                                </div>
                                <button class="btn btn-primary btn-user btn-block" name="register">Register Account</button>
                                  ...
                                  if (isset($_POST['register'])) {
                                      ...
                                      $gender=$_POST['gender'];
                                      $check =mysqli_query($conn," SELECT students.email FROM students,teacher,users WHERE teacher.email='$email' or users.email='$email' or students.email='$email'");
                                      if(mysqli_num_rows($check) > 0){
                                        echo "this email exist. plz try again";
                                    }else{
                                        
                                        $insert=mysqli_query($conn,"INSERT INTO students(`names`, `email`, `DOB`, `address`, `gender`) VALUES ('$full', '$email', '$dob', '$address', '$gender')");
                                      if ($insert) {
